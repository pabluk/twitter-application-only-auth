...
def fake_urlopen(request):
    ...
    try:
        ...
        raise HTTPError(request.get_full_url, 404, "HTTP Error 404: Not Found", {}, None)
...
class ClientTestCase(unittest.TestCase):
    ...
    def setUp(self):
        self.patcher = patch("application_only_auth.client.urlopen", fake_urlopen)
        self.patcher.start()
    ...
    def test_show_status(self):
        ...
        resource_url = "https://api.twitter.com/1.1" "/statuses/show.json?id=316683059296624640"
